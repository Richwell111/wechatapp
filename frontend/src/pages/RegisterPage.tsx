        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-6 flex-1">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-400 text-lg lg:text-xl max-w-md font-light leading-relaxed">
                 Create an account, connect with peers, and join the conversation globally.
              </p>
            </div>
        </div>
        {/* right side */}
        <div className="w-full max-w-md flex-1">
          <form onSubmit={handleRegister} className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 sm:p-10 flex flex-col gap-5 shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-1 mb-2">
              ...
              <p className="text-sm text-gray-400">Get started by creating a new account.</p>
            </div>
            ...
            <p className="text-center text-gray-400 text-sm mt-2">
              ...
              <span onClick={() => navigate("/")} className="text-violet-400 hover:text-violet-300 font-medium cursor-pointer transition-colors underline-offset-4 hover:underline">
                Sign In
              </span>
            </p>
          </form>
